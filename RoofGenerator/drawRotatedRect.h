...
public:
	...
	static void generateRect(cv::Mat & roof_img, int padding, std::vector<std::vector<int>> roof_paras, int relationship, int selected_roof_type, const cv::Scalar& bg_color, const cv::Scalar& fg_color);
