...
cv::Mat RoofD::generateRoof(int width, int height, const std::vector<Config>& roof_paras, const cv::Scalar& bg_color, const cv::Scalar& fg_color, int type, bool bDebug){
