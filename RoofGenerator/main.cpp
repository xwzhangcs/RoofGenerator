...
int main(int argc, char** argv)
{
	...
	start_index = Generator::generate_three_edges_v2(start_index, 3, total, resolution, resolution, step, 16, "../data/roof_data");
	//start_index = Generator::generate_four_edges_v1(start_index, 4, total, resolution, resolution, step, padding, "../data/roof_data");
	//start_index = Generator::generate_four_edges_v2(start_index, 5, total, resolution, resolution, step, padding, "../data/roof_data");
	//start_index = Generator::generate_four_edges_v3(start_index, 6, total, resolution, resolution, step, padding, "../data/roof_data");
