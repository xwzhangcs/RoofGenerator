...
int main(int argc, char** argv)
{
	...
	start_index = Generator::generate_three_edges_v1(start_index, 2, total, 200, 200, 20, padding, "../data/roof_data");
	start_index = Generator::generate_three_edges_v2(start_index, 3, total, 200, 200, 20, padding, "../data/roof_data");
	start_index = Generator::generate_four_edges_v2(start_index, 4, total, 200, 200, 20, padding, "../data/roof_data");
