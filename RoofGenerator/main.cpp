...
int main(int argc, char** argv)
{
	...
	//start_index = Generator::generate_three_edges_v1(start_index, 2, total, resolution, resolution, step, padding, "../data/roof_data"); // 575
	//start_index = Generator::generate_three_edges_v2(start_index, 3, total, resolution, resolution, step, padding, "../data/roof_data"); // 2400
