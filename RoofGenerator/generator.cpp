...
void Generator::generate_four_edges_v1(int width, int height, int step_size, int padding, std::string output_path){
	cv::Scalar bg_color(0, 0, 0);
	cv::Scalar fg_color(0, 0, 255); // bgr
	int index = 0;
	int roof_min_size = 2 * step_size;
...
void Generator::generate_four_edges_v2(int width, int height, int step_size, int padding, std::string output_path){
	cv::Scalar bg_color(0, 0, 0);
	cv::Scalar fg_color(255, 255, 255); // bgr
	int index = 0;
	int roof_min_size = 2 * step_size;
...
void Generator::generate_four_edges_v3(int width, int height, int step_size, int padding, std::string output_path){
	cv::Scalar bg_color(0, 0, 0);
	cv::Scalar fg_color(0, 0, 255); // bgr
	int index = 0;
	int roof_min_size = 2 * step_size;
...
void Generator::generate_four_edges_v4(int width, int height, int step_size, int padding, std::string output_path){
	cv::Scalar bg_color(0, 0, 0);
	cv::Scalar fg_color(0, 0, 255); // bgr
	int index = 0;
	int roof_min_size = 2 * step_size;
